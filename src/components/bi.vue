    ...
    <div class="sideBar">
      <div class="sideList">
        <!--<dl v-for="(outeritem,index) in slideList">
          ...
          &lt;!&ndash;dd选项实现路由机制&ndash;&gt;
         &lt;!&ndash; <dd  router-link   key="index" v-for="(inneritem,innerindex) in outeritem.nextmemu" :to="{path:'/bi/'+inneritem.id,query:{info:'follow'}}"  :class="{ block: (index === 0) }">
